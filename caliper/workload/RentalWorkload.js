...
class RentalWorkload extends WorkloadModuleBase {
    ...
    async submitTransaction() {
        ...
        if (txid < 10 || txid % 2 === 0) {
            ...
            const rentalAddr = rentals[rentalCounter++];  // TODO experimentar com este indice de acesso que é incrementado para cada execução... n sei como é q aceder ao ultimo n dava barraca
